...
process download_gtf {
  ...
  # Get functional region parameters (centralized defaults from nextflow.config)
  PROM_UP="!{ params.functional_regions.prom_up }"
  PROM_DOWN="!{ params.functional_regions.prom_down }"
  DIV_INNER="!{ params.functional_regions.div_inner }"
  DIV_OUTER="!{ params.functional_regions.div_outer }"
  CPS_OFFSET="!{ params.functional_regions.cps_offset }"
  TW_LENGTH="!{ params.functional_regions.tw_length }"
